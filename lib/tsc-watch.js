...
const extractedArgs = extractArgs(process.argv);
const onFirstSuccessCommand = extractedArgs.onFirstSuccessCommand;
const onSuccessCommand = extractArgs.onSuccessCommandconst;
const onFailureCommand = extractArgs.onFailureCommandconst;
const noColors = extractArgs.noColorsconst;
const noClear = extractArgs.noClearconst;
const compiler = extractArgs.compilerconst;
const args = extractArgs.args;
