...
// typescript@2.8.4 => Compilation complete. Watching for file changes.
// typescript@2.9.1 => Found {0} errors. Watching for file changes.
const compilationCompleteRegex = / Watching for file changes\./;
