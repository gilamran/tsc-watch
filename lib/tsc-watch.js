...
const onSuccessCommand = extractArgs.onSuccessCommand;
const onFailureCommand = extractArgs.onFailureCommand;
const noColors = extractArgs.noColors;
const noClear = extractArgs.noClear;
const compiler = extractArgs.compiler;
